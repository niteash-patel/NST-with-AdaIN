...
from utils import get_transform,ImageFolderDataset
...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='/Users/niteshpatel/Desktop/new projet/content',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='/Users/niteshpatel/Desktop/new projet/style_',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='/Users/niteshpatel/Desktop/new projet/vgg_normalised.pth',
